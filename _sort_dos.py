...
parser = argparse.ArgumentParser(description='Takes processed DOS from PROCAR and outputs summed dos for clusters of atoms.')
...
def getProcar(calcPath, bin, orbital, atomSublist):
    ...
    #These are temp files used for debugging
...
try:
    ...
    core_level = 1 # Not in use right now, think about pulling a core atom from the OUTCAR in the future to 
    #reference against a real world experiment like XPS, UPS, or electrochemistry
